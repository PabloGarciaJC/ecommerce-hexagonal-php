...
<head>
    <meta charset="utf-8">
    <title>Amazon Hexagon - Home</title>
...
<body>
    ...
    <main style="max-width:1200px;margin:2rem auto;">
        <section style="display:flex;align-items:center;justify-content:space-between;">
            <div>
                <h1 style="font-size:2.5rem;color:#232f3e;">Bienvenido a Amazon Hexagon</h1>
                <p style="font-size:1.2rem;color:#555;">Tu tienda online con miles de productos, envío rápido y la mejor experiencia.</p>
            </div>
            <img src="/public/assets/img/amazon-hero.png" alt="Amazon style" style="height:180px;">
        </section>
